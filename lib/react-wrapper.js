...
function (_React$Component) {
  ...
  _createClass(Wrapper, [{
    ...
    value: function computeHeight() {
      ...
      if (this.iframeRef.current && this.iframeRef.current.node && this.iframeRef.current.node.contentDocument && this.iframeRef.current.node.contentDocument.body.offsetHeight !== 0 && this.iframeRef.current.node.contentDocument.body.offsetHeight !== height - padding) {
        this.setState({
